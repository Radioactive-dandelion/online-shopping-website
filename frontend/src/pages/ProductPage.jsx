...
function ProductPage() {
  ...
  const handleAddToBag = () => {
    ...
    setActionStatus(`Added ${quantity} item(s) to bag!`);
    setTimeout(() => setActionStatus(""), 3000);
  };
    ...
    <div className="page">
      ...
      <main className="product-layout fw-product-layout">
        ...
        <section className="product-detail-panel fw-detail-panel">
          ...
          {/* Quantity selector */}
          <div className="quantity-section" style={{ marginTop: "1rem" }}>
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            {actionStatus && (
              <p className="status success-status" style={{ marginTop: "0.6rem" }}>
                {actionStatus}
              </p>
            )}
          </div>
