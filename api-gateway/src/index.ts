...
app.get("/api/products", async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      `${PRODUCT_SERVICE_URL}/products`,   // ⬅️ CHANGED
      { params: req.query }
    );
...
app.get("/api/products/search", async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      `${PRODUCT_SERVICE_URL}/products/search`,   // ⬅️ CHANGED
      { params: req.query }
    );
    res.status(response.status).json(response.data);
  } catch (err: any) {
...
app.get("/api/products/:id", async (req: Request, res: Response) => {
  ...
  try {
    const response = await axios.get(
      `${PRODUCT_SERVICE_URL}/products/${id}`   // ⬅️ CHANGED
    );
    res.status(response.status).json(response.data);
  } catch (err: any) {
...
app.get("/api/products/categories", async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      `${PRODUCT_SERVICE_URL}/products/categories`   // needs backend route
    );
    res.status(response.status).json(response.data);
  } catch (err: any) {
...
app.get("/api/products/featured", async (req: Request, res: Response) => {
  try {
    const response = await axios.get(
      `${PRODUCT_SERVICE_URL}/products/featured`,   // needs backend route
      { params: req.query }
    );
    res.status(response.status).json(response.data);
  } catch (err: any) {
