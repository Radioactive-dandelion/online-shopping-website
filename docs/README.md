# Online Store – Microservice-Based Application
...
1. Frontend authenticates users via the User Service
2. Order Service requests user data to associate orders with users
3. Product Service provides product data for display and order creation
